...
3. Write a paragraph to introduce yourself. Set your name in bold font and your major in italic. 
    ...
    Answer: My name is **Claire** and I am a sophomore is *statistics* with a minor in data science.
...
4. Write a paragraph describing a job that you think is related to data science. Include a hyperlink and an image. Make sure your answer is in a nice format to read. 
    ...
    Answer: There is a data scientist position open at Alto Neuroscience, inc. in San Francisco.This company is using artificial intelligence to aid in personalized treatment for mental health disorders.
    https://www.linkedin.com/jobs/view/data-scientist-at-alto-neuroscience-2180235284
    ![Alto Neuroscience](https://media-exp1.licdn.com/dms/image/C560BAQEycsyShmwivg/company-logo_200_200/0/1576824600487?e=2159024400&v=beta&t=3RmVYVJPbO4IAViC4Hp7uVcdSPKiGt0YTww9f_whQxE)
  
5. What data topic will you be most interested in? (Optional) Provide a source of such dataset if you have.

    Answer: I am interested in data about crime.
...
<!-- Then explore the bash command line and Git. -->
    ...
    Answer: 2.30.0.windows.2
  
9. Configure your git username and user email by modifying and entering the following commands into the terminal

    ```
    git config --global user.name "Claire Johnson"
    git config --global user.email "calire17@iastate.edu"
    ```
